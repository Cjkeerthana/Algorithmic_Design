                    ...
                    const size_t n)
{
    ...
    size_t n2 = n/2; //The size of the blocks
    ...
    sum_matrix_blocks(S[5], B, B,
                        ...
                        n2);
    // P5 =  S5 * S6
    strassen_aux(P[4], (const float* const *const) S[4], (const float* const *const) S[5],
                0, 0,
                0, 0,
                0, 0,
                n2);
    ...
    sum_matrix_blocks(S[7], B, B,
                        ...
                        n2);
    // P6 = S7 * S8
    strassen_aux(P[5], (const float* const *const) S[6], (const float* const *const) S[7],
                0, 0,
                0, 0,
                0, 0,
                n2);
    ...
    sum_matrix_blocks(S[9], B, B,
                        ...
                        n2);
    // P7 = S9 * S10            
    strassen_aux(P[6], (const float* const *const) S[8], (const float* const *const) S[9],
                0, 0,
                0, 0,
                0, 0,
                n2);
    ...
    // C11 = P5 + P4 - P2 + P6
    sum_matrix_blocks(C, (const float* const *const) P[4], (const float* const *const) P[3],
                        C_f_row, C_f_col,
                        0, 0,
                        0, 0,
                        n2);
    sub_matrix_blocks(C, (const float* const *const) C, (const float* const *const) P[1],
                        ...
                        0, 0,
                        n2);
    sum_matrix_blocks(C, (const float* const *const) C, (const float* const *const) P[5],
                        C_f_row, C_f_col,
                        C_f_row, C_f_col,
                        0, 0,
                        n2);
    ...
    sum_matrix_blocks(C, (const float* const *const) P[2], (const float* const *const) P[3],
                        ...
                        n2);
    // C22 = P5 + P1 - P3 - P7
    sum_matrix_blocks(C, (const float* const *const) P[4], (const float* const *const) P[0],
